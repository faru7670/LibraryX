...
import { BookOpen, Clock, AlertTriangle, TrendingUp, Loader2 } from 'lucide-react';
...
export default function StudentDashboard() {
    ...
    const cards = [
        { label: 'Books Issued', value: stats?.issuedCount || 0, icon: BookOpen, color: 'from-blue-500 to-cyan-500' },
        ...
        { label: 'Fines', value: `₹${stats?.totalFines || 0}`, icon: Clock, color: 'from-amber-500 to-orange-500' },
    ];
